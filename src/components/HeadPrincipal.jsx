...
const HeadPrincipal = () => {
  return (
    <section id="hero-area" class="header-area header-eight bg-info">
            <div class="container">
              <div class="row align-items-center">
                <div class='d-inline mb-5'>
                <Link to ="/SignUpUsuario">
                  <a class="btn primary-btn text-secondary">Registro de usuario invitado</a>
                </Link>
                <Link to ="/SignupEntidad">
                  <a class="btn primary-btn text-secondary">Registro de entidad</a>
                </Link>
                <Link to ="/LoginUsuario">
                  <a class="btn primary-btn text-secondary">Login</a>
                </Link>
                </div>
